...
<form action="{{route('message.store')}}" method="POST">
    ...
    <div class="row mt-3">
        <div class="form-group col-lg-4">
            <label for="contact_name">{{__('page.contact_name')}}</label>
        ...
        <div class="form-group col-lg-4">
            <label for="contact_email">{{__('page.contact_email')}}</label>
        ...
        <div class="form-group col-lg-4">
            <label for="contact_subject">{{__('page.contact_subject')}}</label>
        ...
        <div class="form-group col-lg-12">
            <label for="contact_message">{{__('page.contact_message')}}</label>
    ...
    <button class="btn ipool-button" type="submit">{{__('page.contact_send')}}</button>
