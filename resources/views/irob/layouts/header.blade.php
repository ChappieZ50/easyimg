<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="{{route('admin.home')}}">
            <img src="{{website_file_url(get_setting('logo'),'/logo.png')}}" alt="logo" style="width: 140px;"/> </a>
        <a class="navbar-brand brand-logo-mini" href="{{route('admin.home')}}">
            <img src="{{website_file_url(get_setting('logo'),'/logo.png')}}" alt="logo" style="width: 100%;"/> </a>
    </div>
