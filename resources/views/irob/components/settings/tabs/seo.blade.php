    ...
    <form class="col-12" action="" method="POST">
        ...
        <div class="row">
            <div class="form-group col-lg-6">
                ...
                <textarea class="form-control col-12" id="site_description" name="site_description"></textarea>
            </div>
            <div class="form-group col-lg-6">
                <label for="site_keywords">Site Keywords</label>
                <textarea class="form-control col-12" id="site_keywords" name="site_keywords"></textarea>
            </div>
        </div>
