            ...
            <div class="row">
                <div class="form-group col-lg-6">
                    ...
                    <input type="number" class="form-control col-12" id="max_file_size"
                           name="max_file_size" value="{{isset($setting) ? $setting->max_file_size : old('max_file_size')}}">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <input type="number" class="form-control col-12" id="one_time_uploads"
                           name="one_time_uploads" value="{{isset($setting) ? $setting->one_time_uploads : old('one_time_uploads')}}">
        ...
        <div class="col-lg-6 col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control col-12" id="dropzone_text"
                       name="dropzone_text" value="{{isset($setting) ? $setting->dropzone_text : old('dropzone_text')}}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control col-12" id="browse_text" name="browse_text" value="{{isset($setting) ? $setting->browse_text : old('browse_text')}}">
            </div>
            <div class="form-group">
                <label for="dropzone_rule">Dropzone Rule Text</label>
                <input type="text" class="form-control col-12" id="dropzone_rule"
                       name="dropzone_rule" value="{{isset($setting) ? $setting->dropzone_rule : old('dropzone_rule')}}">
            </div>
        </div>
    </div>
