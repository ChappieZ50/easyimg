<div class="col-lg-6 grid-margin stretch-card">
    <div class="card">
        <div class="p-4 border-bottom bg-light">
            <h4 class="card-title mb-0">{{__('page.admin_home_chart_users_chart_title')}}</h4>
        </div>
...
<div class="col-lg-6 grid-margin stretch-card">
    <div class="card">
        <div class="p-4 border-bottom bg-light d-flex justify-content-between">
            <h4 class="card-title mb-0">{{__('page.admin_home_latest_users_title')}}</h4>
            <a href="{{ route('admin.user.index') }}" class="btn btn-primary btn-fw">
                <span>{{__('page.admin_home_latest_users_show_all')}}</span>
                        ...
                        <div class="item-content d-flex justify-content-between align-items-center w-100">
                            <div class="user-name d-flex flex-column">
                                <div class="user-name-content">
                                    ...
                                    <span class="text-muted" style="font-size: 14px;">{{__('page.admin_home_latest_users_text')}}</span>
                                </div>
