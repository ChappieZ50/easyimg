<div class="row">
    <form class="col-12" action="{{route('admin.setting.store')}}" method="POST">
        ...
        <h4>{{__('page.admin_settings_seo_title')}}</h4>
        <hr>
        @csrf
        <div class="form-group">
            <label for="site_title">{{__('page.admin_settings_seo_site_title')}}</label>
        ...
        <div class="row">
            <div class="form-group col-lg-6">
                <label for="site_description">{{__('page.admin_settings_seo_site_description')}}</label>
            ...
            <div class="form-group col-lg-6">
                <label for="site_keywords">{{__('page.admin_settings_seo_site_keywords')}}</label>
