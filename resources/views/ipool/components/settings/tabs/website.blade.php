<form class="w-100" action="{{ route('admin.setting.store') }}" method="POST">
    ...
    <div class="row col-12">
        <div class="col-lg-6 col-md-12">
            <h4>{{__('page.admin_settings_website_settings_title')}}</h4>
            <hr>
            <div class="row">
                <div class="form-group col-lg-6">
                    <label for="website_name">{{__('page.admin_settings_website_website_name')}}</label>
                ...
                <div class="form-group col-lg-6">
                    <label for="google_analytics">{{__('page.admin_settings_website_google_analytics')}}</label>
            ...
            <div class="row">
                <div class="form-group col-lg-6">
                    <label for="max_file_size">{{__('page.admin_settings_website_max_file_size')}}</label>
                    ...
                    <div class="small font-italic">{{__('page.admin_settings_website_max_file_size_default')}} 5MB</div>
                </div>
                <div class="form-group col-lg-6">
                    <label for="one_time_uploads">{{__('page.admin_settings_website_one_time_uploads')}}</label>
                    ...
                    <div class="small font-italic">{{__('page.admin_settings_website_max_file_size_default')}} 5</div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-lg-6">
                    <label for="menu_title">{{__('page.admin_settings_website_menu_title')}}</label>
                ...
                <div class="form-group col-lg-6">
                    <label for="uploads_storage">{{__('page.admin_settings_website_uploads_storage')}}</label>
                    ...
                    <div class="small font-italic">{{__('page.admin_settings_website_uploads_storage_default')}}</div>
                </div>
            </div>
            <div class="form-group">
                <label for="theme_color">{{__('page.admin_settings_website_theme_color')}}</label>
                <input type="text" class="form-control col-12" id="theme_color" name="theme_color"
                    ...
                    <div class="small text-muted">{{__('page.admin_settings_website_theme_color_default')}} #2c7ce0</div>
            </div>
        </div>
        <div class="col-lg-6 col-md-12">
            <h4>{{__('page.admin_settings_website_dropzone_settings_title')}}</h4>
            <hr>
            <div class="form-group">
                <label for="dropzone_text">{{__('page.admin_settings_website_dropzone_text')}}</label>
                ...
                <div class="small">
                    {{__('page.admin_settings_website_dropzone_default_1')}}
                </div>
                <div class="small">{{__('page.admin_settings_website_dropzone_default_2')}}</div>
            </div>
            <div class="form-group">
                <label for="browse_text">{{__('page.admin_settings_website_browse_attribute_text')}}</label>
            ...
            <div class="form-group">
                <label for="dropzone_rule">{{__('page.admin_settings_website_dropzone_rule_text')}}</label>
