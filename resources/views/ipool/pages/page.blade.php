    ...
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            @component('ipool.components.card')
                @slot('title',isset($page) ? __('page.admin_page_edit_page_title') : __('page.admin_page_page_title'))
                @slot('body')
                    <form action="{{isset($page) ? route('admin.page.update',$page->id) : route('admin.page.store')}}" method="POST">
                        ...
                        <div class="col-xl-6  col-lg-12 mt-5 mx-auto">
                            <div class="form-group">
                                <label for="page_title">{{__('page.admin_page_title')}}</label>
                            ...
                            <div class="form-group">
                                <label for="page_slug">{{__('page.admin_page_slug')}}</label>
                            ...
                            <div class="form-group">
                                <label for="page_content">{{__('page.admin_page_content')}}</label>
                            ...
                            <div class="form-group form-check-inline">
                                <div class="form-radio mr-2">
                                    <label class="form-check-label">
                                        ...
                                        {{__('page.admin_page_type_default')}}
                                ...
                                <div class="form-radio mr-2">
                                    <label class="form-check-label">
                                        ...
                                        {{__('page.admin_page_type_contact')}}
                                        <i class="input-helper"></i>
                                    </label>
                                </div>
                                <div class="form-radio mr-2">
                                ...
                                <div class="form-radio">
                                    <label class="form-check-label">
                                        ...
                                        {{__('page.admin_page_type_privacy')}}
                                        <i class="input-helper"></i>
                                    </label>
                                </div>
                            </div>
                            <button type="submit"
                                    class="btn btn-primary btn-lg float-right">{{isset($page) ? __('page.admin_page_edit_button') :__('page.admin_page_create_button')}}</button>
                        </div>
                    </form>
                @endslot
            @endcomponent
